...
if st.session_state.username is None:
    ...
    with st.expander("Добавить новую запись"):
        text_input = st.text_area("Введите текст в поле ввода", key="text_input", value=st.session_state.text_input, help="Введине текст используя разделитель 'и' или перенос на новую строку.")
